...
web
\useURL[url1][http://bertdv.nl][][\hyphenatedurl{http://bertdv.nl}]\from[url1]
...
\startdescription{1999}
  ...
  C. Principe.\crlf
   Dissertation title: {\em Temporal processing with neural
...
\startdescription{2012-pres.}
  ...
  \item
    Inaugural lecture:
    \useURL[url7][https://dl.dropboxusercontent.com/u/4512522/cv/Bert\%20de\%20Vries\%20-\%2013sep2013\%20-\%20In\%20situ\%20personalization\%20of\%20signal\%20processing\%20systems\%20-\%20\%20inaugural\%20lecture\%20booklet\%20\%28final\%20version\%29.pdf][][{\em In
...
\startdescription{1992-'93}
  {\bf Postdoctoral Fellow}, \useURL[url12][http://www.sri.com][][David
  Sarnoff Research Center]\from[url12], Princeton, NJ

  \startitemize[packed]
  \item
    Developed neural network based speech recognition method
    (50\letterpercent{} error reduction relative to competing methods)
  \stopitemize
\stopdescription
...
\item
  Leiden University Medical Center, keynote lecture on
...
\item
  2012 - pres., Invited member annual European Mathworks Advisory Board
  meetings
\item
...
\item
  {\bf 2005 - pres.},
  {\bf \useURL[url16][http://bertdv.github.io/teaching/5mb20/index.html][][Adaptive
  Information Processing]\from[url16]}. Together with
  \useURL[url17][http://www.sps.ele.tue.nl/members/T.J.Tjalkens][][dr.ir.
  Tjalling Tjalkens]\from[url17], since spring 2005 I teach a core
  graduate class on the fundamentals of machine learning.
\item
  2004, Machine Learning. I organized a machine learning reading club
  for TU/e graduate students and GN ReSound staff.
\stopitemize

\subsubsection[research]{Research}
...
\startitemize
\item
  In December 2014, together with
  \useURL[url18][http://www.sps.ele.tue.nl/members/T.J.Tjalkens/][][Tjalling
  Tjalkens]\from[url18], we received a \lettertilde{}500K euro grant
  from Dutch Technology Foundation
  \useURL[url19][http://www.stw.nl/en/][][STW]\from[url19] to pursue
  research on
  \useURL[url20][http://stw.nl/nl/content/hearscan-towards-data-driven-hearing-aids][][Data-driven
  Hearing Aids]\from[url20].
\item
  In July 2006, together with
  \useURL[url21][http://www.cs.ru.nl/staff/Tom.Heskes][][Tom
  Heskes]\from[url21] and
  \useURL[url22][http://www.ac-amc.nl/medewerkers/dreschler.html][][Wouter
  Dreschler]\from[url22], we received a \lettertilde{}650K euro grant
  from \useURL[url23][http://www.stw.nl][][STW]\from[url23] to pursue
  further research on
  \useURL[url24][http://www.nwo.nl/en/research-and-results/research-projects/35/2300148635.html][][Personalization
  of Hearing Aids through Bayesian Preference Elicitation]\from[url24].
\stopitemize
...
\item
  ...
  \useURL[url25][https://dl.dropboxusercontent.com/u/4512522/cv/Duijkers\%20-\%202014\%20-\%20Bayesian\%20Online\%20Spectral\%20Tracking.pdf][][{\em Online
  Bayesian Spectral Tracking}]\from[url25]
\item
...
\item
  ...
  \useURL[url26][https://dl.dropboxusercontent.com/u/4512522/cv/ZijianXu\%20-\%202013\%20-\%20Fast\%20Design\%20of\%20Audio\%20Processing\%20Algorithms\%20by\%20Interactive\%20Parameter\%20Exploration.pdf][][{\em Fast
  Design of Audio Processing Algorithms by Interactive Parameter
  Exploration}]\from[url26]
\item
  8/2013, Timur Bagautdinov, M.Sc. thesis project,
  \useURL[url27][https://dl.dropboxusercontent.com/u/4512522/cv/Bagautdinov\%20-\%202013\%20-\%20A\%20Machine\%20Learning\%20Framework\%20for\%20Bayesian\%20Signal\%20Processing.pdf][][{\em A
  Machine Learning Framework for Bayesian Signal
  Processing}]\from[url27]
\item
...
\item
  ...
  \useURL[url28][https://dl.dropboxusercontent.com/u/4512522/cv/Bagautdinov\%20-\%202012\%20-\%20A\%20MATLAB-C\%2B\%2B\%20toolbox\%20for\%20Factor\%20Graph\%20Modeling.pdf][][{\em A
  MATLAB/C++ toolbox for Factor Graph Modeling}]\from[url28]
\item
  6/2012, Maarten Thomassen, M.Sc. practical training project,
  {\em Spectral Audio Monitoring}
\item
  4/2012, Joris Kraak, M.Sc.-thesis,
  \useURL[url29][https://dl.dropboxusercontent.com/u/4512522/cv/Kraak\%20-\%202012\%20-\%20Computer-Aided\%20Algorithm\%20Design\%20for\%20Audio\%20Processing.pdf][][{\em Computer-Aided
  Algorithm Design for Audio Processing}]\from[url29]
\item
...
\item
  ...
  \useURL[url30][https://dl.dropboxusercontent.com/u/4512522/cv/Li\%20-\%202010\%20-\%20acoustic-scene-adaptive-speech-enhancement.pdf][][{\em Acoustic
  scene-adaptive speech enhancement}]\from[url30]
\item
...
\item
  See also my
  \useURL[url25][http://scholar.google.nl/citations?user=x3EIIHEAAAAJ][][google
  scholar page]\from[url25]
\stopitemize

\subsubsection[under-review]{Under Review}

\startitemize[n,packed][stopper=.]
\item
  Marco Cox and Bert de Vries,
  \useURL[url26][http://arxiv.org/abs/1511.08670][][A Bayesian binary
  classification approach to pure tone audiometry]\from[url26],
  submitted to the {\em Journal of the Acoustical Society of America},
  Sep. 2015
\stopitemize
...
\item
  A. Ypma et al.,
  \useURL[url26][http://www.hindawi.com/GetArticle.aspx?doi=10.1155/2008/183456][][On-line
  Personalization of Hearing Instruments]\from[url26], {\em EURASIP
  Journal on Audio, Speech, and Music Processing}, September 2008
\item
  Tjeerd Dijkstra et al.,
  \useURL[url27][http://www.hearingreview.com/issues/articles/2007-10_05.asp][][The
  Learning Hearing Aid: Common-Sense Reasoning in Hearing Aid
  Circuits]\from[url27], The Hearing Review, issue October 2007
\item
...
\item
  ...
  signal processing_ vol.~41(2), pp.~649-656, 1992
\item
  Bert de Vries,
  \useURL[url28][http://ufdc.ufl.edu/UF00082173/00001][][Temporal
  processing with neural networks-the development of the Gamma
  model]\from[url28], {\em Ph.D.~dissertation}, University of Florida,
  1991
\item
...
\startitemize[n,packed][stopper=.]
\item
  \useURL[url26][http://www.audiology-worldnews.com/focus-on/1215-introducing-data-science-hearing-aids-on-the-brink-of-a-paradigm-shift][][Introducing
  Data Science: Hearing Aids on the Brink of a Paradigm
  Shift]\from[url26]. Interview in
  \useURL[url27][http://www.audiology-worldnews.com/][][Audiology Info
  Magazine]\from[url27], Dec 2014
\stopitemize
...
\item
  ...
  delays, {\em NIPS-3 Proceedings}, Denver, 1991
\item
