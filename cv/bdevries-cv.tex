...
\startblockquote
GN Hearing & Eindhoven University of Technology\crlf
Het Eeuwsel 6\crlf
...
Signal processing, (Bayesian) machine learning, computational
neuroscience, data science, biomedical engineering, research management,
technical writing; applications to multimedia processing, medical
devices, hearing rehabilitation and clinical trial design/analysis.

\subsection[academic-background]{Academic Background}

\startdescription{1991}
...
\startdescription{2012-pres.}
  ...
  \item
    Founder/director
    \useURL[url6][http://biaslab.org][][BIASlab]\from[url6] research
    laboratory
  \item
  ...
  \item
    ...
    \useURL[url7][http://www.sps.ele.tue.nl/members/b.vries/teaching/5mb20/index.html][][Adaptive
    Information Processing]\from[url7]
  \item
    Inaugural lecture:
    \useURL[url8][./files/Bert\%20de\%20Vries\%20-\%2013sep2013\%20-\%20In\%20situ\%20personalization\%20of\%20signal\%20processing\%20systems\%20-\%20\%20inaugural\%20lecture\%20booklet\%20\%28final\%20version\%29.pdf][][{\em In
    Situ Personalization of Signal Processing Systems}]\from[url8] (at
    \useURL[url9][http://goo.gl/EoU0SE][][youtube]\from[url9]),
    Sep.~2013
  \stopitemize
\stopdescription
...
\startdescription{1999-pres.}
  ...
  \useURL[url10][http://www.gnresound.dk/][][GN ReSound]\from[url10]
...
\startdescription{1992-'99}
  ...
  \useURL[url11][http://www.sarnoff.com/][][Sarnoff
  Corporation]\from[url11] (today
  \useURL[url12][http://www.sri.com][][SRI Int'l]\from[url12]),
  Princeton, NJ
...
\startdescription{1987-'91}
  ...
  \useURL[url13][http://www.ufl.edu/][][University of
  Florida]\from[url13], Gainesville, FL
...
\startitemize
\item
  Annual conference Kring Klinische Audiologie, \quotation{In-situ
  Personalization of Hearing Devices}, Putten (NL), Nov.~2017
\item
...
\item
  \useURL[url14][http://www.cqm.nl/][][CQM]\from[url14], \quotation{In
...
\item
  ...
  \useURL[url15][http://tnsre.embs.org/][][IEEE Transactions on Neural
  Systems and Rehabilitation Engineering]\from[url15]
\item
...
\item
  ...
  Brussels
\item
  5/2002, Organizer/chair special session \quotation{DSP for Intelligent
  Hearing Aids}, ICASSP 2002, Orlando, FL
\item
...
\startitemize
\item
  2018 - 2022, together with dr.
  \useURL[url16][https://www.linkedin.com/in/henkjan-huisman-28a7b34b/][][Henkjan
  Huisman]\from[url16] and prof.
  \useURL[url17][http://www.es.ele.tue.nl/~heco/][][Henk
  Corporaal]\from[url17], {\bf \lettertilde{}275K euro} to support 1 PhD
  student, from \useURL[url18][https://www.nwo.nl/en][][NWO]\from[url18]
  for research on \quotation{deep learning for human and animal health},
  in the context of
  \useURL[url19][https://www.nwo.nl/en/news-and-events/news/2017/32-million-euros-for-top-level-technological-research.html\#zelflerend][][Efficient
  Deep Learning]\from[url19].
\item
  2017 - 2021, together with dr.
  \useURL[url20][http://www.es.ele.tue.nl/~sander/][][Sander
  Stuijk]\from[url20] and prof.
  \useURL[url21][http://www.es.ele.tue.nl/~heco/][][Henk
  Corporaal]\from[url21], {\bf \lettertilde{}550K euro} supporting 3 PhD
  students, from \useURL[url22][http://www.stw.nl/en][][STW]\from[url22]
  to pursue research on \useURL[url23][][][Autonomous Acoustic
  Systems]\from[url23] in the context of
  \useURL[url24][http://www.stw.nl/en/node/8025][][energy-autonomous
  systems for IoT]\from[url24].
\item
  2015 - 2019, together with dr.
  \useURL[url25][http://www.sps.ele.tue.nl/members/T.J.Tjalkens/][][Tjalling
  Tjalkens]\from[url25], {\bf \lettertilde{}500K euro} supporting 2 PhD
  students, from Dutch Technology Foundation
  \useURL[url26][http://www.stw.nl/en/][][STW]\from[url26] to pursue
  research on
  \useURL[url27][http://stw.nl/nl/content/hearscan-towards-data-driven-hearing-aids][][Data-driven
  Hearing Aids]\from[url27].
\item
...
\item
  ...
  \useURL[url28][http://www.cs.ru.nl/staff/Tom.Heskes][][Tom
  Heskes]\from[url28] and
  \useURL[url29][http://www.ac-amc.nl/medewerkers/dreschler.html][][Wouter
  Dreschler]\from[url29], {\bf \lettertilde{}650K euro} grant from
  \useURL[url30][http://www.stw.nl][][STW]\from[url30] to pursue further
  research on
  \useURL[url31][http://www.nwo.nl/en/research-and-results/research-projects/35/2300148635.html][][Personalization
  of Hearing Aids through Bayesian Preference Elicitation]\from[url31].
\stopitemize
...
\item
  {\bf 2005 - pres.},
  \useURL[url32][http://bertdv.github.io/teaching/AIP-5SSB0/][][{\bf Adaptive
  Information Processing}]\from[url32]. Together with
  \useURL[url33][http://www.sps.ele.tue.nl/members/T.J.Tjalkens][][dr.ir.
  Tjalling Tjalkens]\from[url33], since spring 2005 I teach a core
...
\item
  10/2017, Ismail Senoz, M.Sc. thesis report, {\em Generative
  Probabilistic Models for Audio Textures}
\item
  9/2017, Jiyang Li, M.Sc. internship, {\em Online Preference Learning}
\item
  5/2017, Anouk van Diepen, M.Sc. thesis report, {\em A Probabilistic
  Modeling Approach to In-situ Trainable Gesture Recognition}
\item
...
\item
  ...
  \useURL[url34][./files/Duijkers\%20-\%202014\%20-\%20Bayesian\%20Online\%20Spectral\%20Tracking.pdf][][{\em Online
  Bayesian Spectral Tracking}]\from[url34]
\item
...
\item
  ...
  \useURL[url35][./files/ZijianXu\%20-\%202013\%20-\%20Fast\%20Design\%20of\%20Audio\%20Processing\%20Algorithms\%20by\%20Interactive\%20Parameter\%20Exploration.pdf][][{\em Fast
  Design of Audio Processing Algorithms by Interactive Parameter
  Exploration}]\from[url35]
\item
  8/2013, Timur Bagautdinov, M.Sc. thesis project,
  \useURL[url36][./files/Bagautdinov\%20-\%202013\%20-\%20A\%20Machine\%20Learning\%20Framework\%20for\%20Bayesian\%20Signal\%20Processing.pdf][][{\em A
  Machine Learning Framework for Bayesian Signal
  Processing}]\from[url36]
\item
...
\item
  ...
  \useURL[url37][./files/Bagautdinov\%20-\%202012\%20-\%20A\%20MATLAB-C\%2B\%2B\%20toolbox\%20for\%20Factor\%20Graph\%20Modeling.pdf][][{\em A
  MATLAB/C++ toolbox for Factor Graph Modeling}]\from[url37]
\item
  6/2012, Maarten Thomassen, M.Sc. practical training project,
  {\em Spectral Audio Monitoring}
\item
  4/2012, Joris Kraak, M.Sc.-thesis,
  \useURL[url38][./files/Kraak\%20-\%202012\%20-\%20Computer-Aided\%20Algorithm\%20Design\%20for\%20Audio\%20Processing.pdf][][{\em Computer-Aided
  Algorithm Design for Audio Processing}]\from[url38]
\item
...
\item
  ...
  \useURL[url39][./files/Li\%20-\%202010\%20-\%20acoustic-scene-adaptive-speech-enhancement.pdf][][{\em Acoustic
  scene-adaptive speech enhancement}]\from[url39]
\item
...
\item
  02/2018, Henk Kortier, Ph.D., Assessment of Hand Kinematics and
  Interactions with the Environment, University of Twente.
\item
...
\item
  ...
  \useURL[url34][http://scholar.google.nl/citations?user=x3EIIHEAAAAJ][][google
  scholar page]\from[url34].
\stopitemize
...
\item
  ...
  \useURL[url35][https://www.frontiersin.org/articles/10.3389/fncom.2017.00095/full][][A
  Factor Graph Description of Deep Temporal Active
  Inference]\from[url35], {\em Frontiers in Computational Neuroscience},
  https://doi.org/10.3389/fncom.2017.00095, Oct.~2017
\item
  Karl J. Friston, Thomas Parr and Bert de Vries,
  \useURL[url36][http://www.mitpressjournals.org/doi/abs/10.1162/NETN_a_00018][][The
  graphical brain: belief propagation and active inference]\from[url36],
  {\em Network Neuroscience}, the MIT Press, vol.1, no.1, pp.1-78, 2017
\item
  Thijs van de Laar and Bert de Vries,
  \useURL[url37][http://arxiv.org/abs/1602.01345][][A Probabilistic
  Modeling Approach to Hearing Loss Compensation]\from[url37], {\em IEEE
...
\item
  A. Ypma et al.,
  \useURL[url38][http://www.hindawi.com/GetArticle.aspx?doi=10.1155/2008/183456][][On-line
  Personalization of Hearing Instruments]\from[url38], {\em EURASIP
  Journal on Audio, Speech, and Music Processing}, September 2008
\item
  Tjeerd Dijkstra et al.,
  \useURL[url39][http://www.hearingreview.com/issues/articles/2007-10_05.asp][][The
  Learning Hearing Aid: Common-Sense Reasoning in Hearing Aid
  Circuits]\from[url39], The Hearing Review, issue October 2007
\item
...
\item
  Bert de Vries,
  \useURL[url40][http://ufdc.ufl.edu/UF00082173/00001][][Temporal
  processing with neural networks-the development of the Gamma
  model]\from[url40], {\em Ph.D.~dissertation}, University of Florida,
  1991
\item
...
\startitemize[n][stopper=.,width=2.0em]
\item
  Bert de Vries, Marco Cox and Joris Kraak, Hearing Device and Method
...
\item
  Andrew Dittberner, Bert de Vries et al., A Location Learning Hearing
...
\item
  Bert de Vries et al., Efficient evaluation of hearing ability, filed
  by GN ReSound, US Patent 9,560,991 (granted 2017), priority date April
  2009
\item
  Alexander Ypma et al., Asymmetric adjustment, filed by GN ReSound, US
  patent 8792659 (granted 7/2014), priority date Nov-2008
\item
  Alexander Ypma et al., Learning control of hearing aid parameter
  settings, filed by GN ReSound, US patent 9408002 (granted 8/2016),
...
\item
  \useURL[url35][http://www.audiology-worldnews.com/focus-on/1215-introducing-data-science-hearing-aids-on-the-brink-of-a-paradigm-shift][][Introducing
  Data Science: Hearing Aids on the Brink of a Paradigm
  Shift]\from[url35]. Interview in
  \useURL[url36][http://www.audiology-worldnews.com/][][Audiology Info
  Magazine]\from[url36], Dec 2014
\stopitemize
...
\item
  ...
  \useURL[url35][http://media.aau.dk/smc/ml4audio/][][machine learning
  for audio signal processing]\from[url35], Long Beach (CA), Dec 2017
\item
  Marco Cox and Bert de Vries, A parametric approach to Bayesian
  optimization with pairwise comparisons.
  \useURL[url36][http://bayesopt.com/][][NIPS-2017 workshop on Bayesian
  Optimization]\from[url36], Long Beach (CA), Dec 2017
\item
  ...
  EUSIPCO-2017, KOS Island (Greece), Aug.2017
\item
