...
\item
  ...
  \useURL[url30][http://www.mitpressjournals.org/doi/abs/10.1162/NETN_a_00018][][The
  graphical brain: belief propagation and active inference]\from[url30],
  {\em Network Neuroscience}, the MIT Press, vol.1, no.1, pp.1-78, 2017
\item
  Thijs van de Laar and Bert de Vries,
  \useURL[url31][http://arxiv.org/abs/1602.01345][][A Probabilistic
  Modeling Approach to Hearing Loss Compensation]\from[url31], {\em IEEE
...
\item
  A. Ypma et al.,
  \useURL[url32][http://www.hindawi.com/GetArticle.aspx?doi=10.1155/2008/183456][][On-line
  Personalization of Hearing Instruments]\from[url32], {\em EURASIP
  Journal on Audio, Speech, and Music Processing}, September 2008
\item
  Tjeerd Dijkstra et al.,
  \useURL[url33][http://www.hearingreview.com/issues/articles/2007-10_05.asp][][The
  Learning Hearing Aid: Common-Sense Reasoning in Hearing Aid
  Circuits]\from[url33], The Hearing Review, issue October 2007
\item
...
\item
  Bert de Vries,
  \useURL[url34][http://ufdc.ufl.edu/UF00082173/00001][][Temporal
  processing with neural networks-the development of the Gamma
  model]\from[url34], {\em Ph.D.~dissertation}, University of Florida,
  1991
\item
